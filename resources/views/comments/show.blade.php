    ...
    <div class="bg-white border-2 border-gray-200 shadow-lg p-8 mb-8">
        ...
        <div class="mb-6">
            <nav class="flex items-center gap-2 text-sm">
                <a href="{{ route('home') }}" class="text-pink-600 hover:text-pink-800">Главная</a>
                <span class="text-gray-400">/</span>
                <a href="{{ route('comments.index') }}" class="text-pink-600 hover:text-pink-800">Комментарии</a>
                <span class="text-gray-400">/</span>
                <span class="text-gray-600">Просмотр #{{ $comment->id }}</span>
            </nav>
        </div>
